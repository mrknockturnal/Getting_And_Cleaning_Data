...
#Now merging the training and test sets to create one data set

# read train data
X_train <- read.table("./getdata/UCI HAR Dataset/train/X_train.txt")
Y_train <- read.table("./getdata/UCI HAR Dataset/train/Y_train.txt")
Sub_train <- read.table("./getdata/UCI HAR Dataset/train/subject_train.txt")

# read test data
X_test <- read.table("./getdata/UCI HAR Dataset/test/X_test.txt")
Y_test <- read.table("./getdata/UCI HAR Dataset/test/Y_test.txt")
Sub_test <- read.table("./getdata/UCI HAR Dataset/test/subject_test.txt")

# read data description
variable_names <- read.table("./getdata/UCI HAR Dataset/features.txt")
...
write.table(total_mean, file = "./getdata/UCI HAR Dataset/new_tidydata.txt", row.names = FALSE, col.names = TRUE)
